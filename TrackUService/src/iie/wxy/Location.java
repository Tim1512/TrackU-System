...
//			System.out.println(date+":before="+array.length()+",after="+apArray.length()+", lv="+((double)apArray.length()/array.length()));
		}else {
			apArray = array;
		}
		timestamp = Utils.getTimestamp(date, time);
	...
	public String toString(){
		return date+","+time+","+strLatitude+","+strLongitude;//+","+tempDistance+","+tempSignal
	}
